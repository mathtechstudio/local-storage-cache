...
/**
 * LocalStorageCacheMacosPlugin
 * 
 * macOS implementation of the local_storage_cache plugin.
 * Shares most code with iOS implementation.
 */
public class LocalStorageCacheMacosPlugin: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let instance = LocalStorageCacheMacosPlugin()
